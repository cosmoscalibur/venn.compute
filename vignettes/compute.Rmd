...
```{r read, results='asis'}
sets <- read.lists_from_files(c("test/primes.txt", "test/even.txt", "test/fibo.txt"), c("primes", "even", "fibo"))
print(sets)
```
...
venn.compute_specific(sets, output_dir = "test/output")
dir("test/output")
```
...
```{r plot, results='asis'}
venn.compute_plot(sets, output_dir = "test/output")
dir("test/output")
```

```{r, out.width='60%', fig.align='center', fig.cap='Venn diagram example generated with this code'}
knitr::include_graphics('../test/output/primes_even_fibo.png')
```
